...
<section id="service" class="section-padding">
    <div class="container" align='center'>
        ...
        <hr class="botm-line">
            ...
            <%
                float newPrice = Float.valueOf(request.getParameter("price2"));
				String newBeer = request.getParameter("beer2");
...
%>
    ...
    try {
		...
		//String insert = "UPDATE sells SET price = "+newPrice + " where bar = "+barName+" and beer = "+newBeer;
         String insert = "UPDATE sells SET price = "+"(?)" + " where bar = "+"(?)"+" and beer = "+"(?)";
		...
		ps.setString(2, barName);
		ps.setString(3, newBeer);
